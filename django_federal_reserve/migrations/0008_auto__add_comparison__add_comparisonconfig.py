...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'django_federal_reserve_comparison', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('config', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comparisons', to=orm['django_federal_reserve.ComparisonConfig'])),
            ('series', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comparisons', to=orm['django_federal_reserve.Series'])),
            ('fresh', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('correlation', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'django_federal_reserve', ['Comparison'])

        # Adding model 'ComparisonConfig'
        db.create_table(u'django_federal_reserve_comparisonconfig', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('series', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comparison_configs', to=orm['django_federal_reserve.Series'])),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('offset_days', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('other_filter', self.gf('django.db.models.fields.CharField')(default='one-day-diff-bool', max_length=50)),
        ))
        db.send_create_signal(u'django_federal_reserve', ['ComparisonConfig'])


    def backwards(self, orm):
        # Deleting model 'Comparison'
        db.delete_table(u'django_federal_reserve_comparison')

        # Deleting model 'ComparisonConfig'
        db.delete_table(u'django_federal_reserve_comparisonconfig')

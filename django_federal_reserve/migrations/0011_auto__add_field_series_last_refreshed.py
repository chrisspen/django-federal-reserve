...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Series.last_refreshed'
        db.add_column(u'django_federal_reserve_series', 'last_refreshed',
                      self.gf('django.db.models.fields.DateField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Series.last_refreshed'
        db.delete_column(u'django_federal_reserve_series', 'last_refreshed')


    models = {
        u'django_federal_reserve.comparison': {
            'Meta': {'ordering': "('config', '-abs_correlation')", 'object_name': 'Comparison'},
            'abs_correlation': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'django_federal_reserve.series': {
            ...
            'last_refreshed': ('django.db.models.fields.DateField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),

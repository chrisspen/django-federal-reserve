...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Series.enabled'
        db.add_column(u'django_federal_reserve_series', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding index on 'Series', fields ['active']
        db.create_index(u'django_federal_reserve_series', ['active'])


    def backwards(self, orm):
        # Removing index on 'Series', fields ['active']
        db.delete_index(u'django_federal_reserve_series', ['active'])

        # Deleting field 'Series.enabled'
        db.delete_column(u'django_federal_reserve_series', 'enabled')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Series.date_is_start'
        db.add_column(u'django_federal_reserve_series', 'date_is_start',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Series.date_is_start'
        db.delete_column(u'django_federal_reserve_series', 'date_is_start')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comparison.abs_correlation'
        db.add_column(u'django_federal_reserve_comparison', 'abs_correlation',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comparison.abs_correlation'
        db.delete_column(u'django_federal_reserve_comparison', 'abs_correlation')

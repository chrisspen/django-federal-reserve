...
class Command(BaseCommand):
    ...
    option_list = BaseCommand.option_list + (
        make_option('--config', help='Specific config to update.'),
        make_option('--other-series', help='Specific other series to update.'),
        make_option('--force', action='store_true', default=False, help='Ignores fresh flag.'),
        #         make_option('--delete',
        #             action='store_true',
        #             default=False,
